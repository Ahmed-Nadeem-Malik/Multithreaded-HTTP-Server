...
Running 1m test @ http://localhost:8080/
  ...
  Thread Stats   Avg      Stdev     Max   +/- Stdev
    Latency    75.95us   14.23us 813.00us   75.37%
    Req/Sec    83.11k     9.70k   95.45k    52.91%
  9941169 requests in 1.00m, 13.50GB read
  Socket errors: connect 757, read 32, write 0, timeout 0
Requests/sec: 165403.78
Transfer/sec:    229.99MB
```

- **165,404 requests/second** - High throughput under extreme load
- **75.95us average latency** - Consistent microsecond response times
- **9.94 million total requests** in 60 seconds
- **229.99 MB/sec transfer rate**
- **75.37% low jitter** - Stdev within 14.23us
